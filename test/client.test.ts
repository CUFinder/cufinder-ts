...
describe('CufinderClient', () => {
  ...
  describe('get', () => {
    it('should make GET request', async () => {
      ...
      const result = await client.get('/test', { param: 'value' }, { 'Custom-Header': 'value' });
  ...
  describe('post', () => {
    it('should make POST request', async () => {
      ...
      const result = await client.post('/test', { data: 'value' }, { 'Custom-Header': 'value' });
  ...
  describe('utility methods', () => {
    ...
    it('should get base URL', () => {
      ...
      expect(baseUrl).toBe('https://api.cufinder.io');
    });
