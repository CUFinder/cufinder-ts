import { Cse } from '../../src/services/cse';
import { CufinderClient } from '../../src/client';
import { CseResponse } from '../../src/shared/types';
...
describe('Cse', () => {
    ...
    describe('searchCompanies', () => {
        const mockResponse: CseResponse = {
            query: 'technology',
            credit_count: 1,
            meta_data: {
                user_id: 123,
        ...
        it('should successfully search companies with all parameters', async () => {
            ...
            expect(mockClient.post).toHaveBeenCalledWith('/cse', params);
        });
        ...
        it('should successfully search companies with minimal parameters', async () => {
            ...
            expect(result).toEqual(mockResponse);
            expect(mockClient.post).toHaveBeenCalledWith('/cse', validParams);
        });
        ...
        it('should successfully search companies with no parameters', async () => {
            ...
            expect(result).toEqual(mockResponse);
            expect(mockClient.post).toHaveBeenCalledWith('/cse', {});
        });
