import { CufV2 } from '../../../src/services/v2/cuf';
import { CufinderClient } from '../../../src/client';
import { CufV2Response } from '../../../src/shared/types';
...
describe('CufV2', () => {
  ...
  describe('getDomain', () => {
    const mockResponse: CufV2Response = {
      query: 'TechCorp',
      credit_count: 1,
      meta_data: {
        user_id: 123,
    ...
    it('should successfully get domain', async () => {
      ...
      expect(mockClient.post).toHaveBeenCalledWith('/v2/cuf', {
